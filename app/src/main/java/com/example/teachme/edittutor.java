...
public class edittutor extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    FirebaseAuth fauth;
    FirebaseFirestore fstore;
    DocumentReference ref1;
    Button btn;
    String tutorgender = "", tutormode = "";
    EditText tname12, tmobile12, tage12, tmail12, thome12, tstreet122, tcity12, tstate12, tpin12,taddress;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ref1.addSnapshotListener(this, new EventListener<DocumentSnapshot>() {
            ...
            public void onEvent(@Nullable DocumentSnapshot value, @Nullable FirebaseFirestoreException error) {
                ...
                tname12.setText(value.getString("tname"));
                tmobile12.setText(value.getString("tmobile"));
                tage12.setText(value.getString("tage"));
                tcity12.setText(value.getString("tcity"));
                tstate12.setText(value.getString("tstate"));
                tpin12.setText(value.getString("tpin"));
                taddress.setText(value.getString("taddress"));
            }
        });
    ...
    public void onClick(View v) {
        if (OK()) {
            ...
            tutor.put("tname",tname12.getText().toString());
            tutor.put("tage",tage12.getText().toString());
            tutor.put("tcity",tcity12.getText().toString());
            tutor.put("tgender",tutorgender);
            tutor.put("taddress",taddress.getText().toString());
            tutor.put("tpin",tpin12.getText().toString());
            tutor.put("tstate",tstate12.getText().toString());
            tutor.put("tmobile",tmobile12.getText().toString());
            tutor.put("tmode",tutormode);
            tutor.put("tskills",skills.toString());
            tutor.put("timing",timing.toString());

            ref1.update(tutor).addOnSuccessListener(new OnSuccessListener<Void>() {
                @Override
                public void onSuccess(Void aVoid) {
                    Toast.makeText(edittutor.this, "Updated Successfully", Toast.LENGTH_SHORT).show();
                }
            });
    ...
    public boolean OK() {
        ...
        if (TextUtils.isEmpty(tpin12.getText().toString()) || TextUtils.isEmpty(tstate12.getText().toString())||
                TextUtils.isEmpty(tcity12.getText().toString())||TextUtils.isEmpty(tname12.getText().toString())
                ||TextUtils.isEmpty(tmobile12.getText().toString())||TextUtils.isEmpty(tage12.getText().toString())||TextUtils.isEmpty(taddress.getText().toString())) {
