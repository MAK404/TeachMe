...
public class studentupload extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        studentID = getIntent().getStringExtra("stid3");
        ...
        tprofilebtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ImagePicker.Companion.with(studentupload.this)
                        .galleryOnly()
                        .cropSquare()
        ...
        intluploadbutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(OK()) {
                    ...
                    StorageReference fileref = storageReference.child("tutorsandstudents/" + studentID + "/profile");
                    StorageReference fileref2 = storageReference.child("tutorsandstudents/" + studentID + "/idproof");
